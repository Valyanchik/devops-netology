...
Доступность сайта по FQDN а не по ip адресу проверил при помощи curl:  
![img_17.png](img_17.png)
Проверка ругнулась на сертификат сайта, т.к он подписан не доверенным источником, как и в случае просмотра через браузер(пример выше)      
